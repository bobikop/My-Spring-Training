...
public interface AccountRepository extends JpaRepository<Account, Long> {
    ...
    List<Account> findALByAgeLessThanEqual (Integer age);
...
//    List<Account> findByAgeIsNullOrderByAgeDesc();
//    List<Account> findByAgeIsNullOrderByAgeAsc();
    ...
    List<Account> readAllAccountsWithAgeLowerThan(int age);
...
//    List<Account>  readAllAccountsContainsNameAddressCountryStateCity(String name, String address, String country, String state, String city);

    //Write a native query to read all accounts with an age higher than a specific value
    @Query(value = "SELECT * FROM account_details where age > ?1", nativeQuery = true)
    List<Account> readAllAccountsWithAgeHigherThan(Integer age );
