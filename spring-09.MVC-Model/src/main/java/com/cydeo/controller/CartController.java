...
public class CartController {
    ...
    public String carInfo(@RequestParam String make, Model model){
        ...
        model.addAttribute("make",make);// filtering cars form DB
...
//        System.out.println(make);
    ...
    public String carInfo2(@RequestParam(value = "make",required = false,defaultValue = "KIA") String make, Model model){  //create default value
